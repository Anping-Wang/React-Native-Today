                ...
                <View style={styles.headContainer}>
                    ...
                    <View style={styles.headTopContainer}>
                        <TouchableOpacity style={styles.topBtnStyle} activeOpacity={0.9} onPress={() => {alert('夜间')}}>
                            <Image source={require('./../../images/yejian.png')} style={styles.headTopImg} resizeMode={'contain'} />
                            <Text style={styles.headTopText}>夜间</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.topBtnStyle} activeOpacity={0.9} onPress={() => {alert('签到')}}>
                            <Image source={require('./../../images/qiandao.png')} style={styles.headTopImg} resizeMode={'contain'} />
                    ...
                    <View style={styles.headCenterContainer}>
                        ...
                        }]} source={require('./../../images/header.png')} resizeMode={'contain'} />
                        ...
                        <View style={styles.positionContainer}>
                            <Image style={styles.positionImg} source={require('./../../images/label.png')} />
        ...
        return(
            <TouchableOpacity activeOpacity={0.9} style={[styles.itemContainer, this.props.isShowUnderline && styles.itemBorderBottom]} onPress={this.props.onPress}>
                ...
                <View style={styles.itemRightContainer}>
                    ...
                    {
                        !this.props.rightComponent && this.props.isShowArrow && <Image style={styles.itemRightImg} source={require('./../../images/right_arrow.png')}/>
                    }
                </View>
            </TouchableOpacity>
        )
